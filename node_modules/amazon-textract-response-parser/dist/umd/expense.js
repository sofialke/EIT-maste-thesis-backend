(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./base", "./geometry"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.TextractExpense = exports.ExpenseDocument = exports.ExpenseLineItemGroup = exports.ExpenseLineItem = exports.ExpenseField = exports.ExpenseFieldType = exports.ExpenseComponentDetection = void 0;
    const base_1 = require("./base");
    const geometry_1 = require("./geometry");
    class ExpenseComponentDetection extends base_1.ApiObjectWrapper {
        constructor(dict, parentField) {
            super(dict);
            this._parentField = parentField;
            this._geometry = dict.Geometry ? new geometry_1.Geometry(dict.Geometry, this) : undefined;
        }
        get confidence() {
    ...
    exports.ExpenseComponentDetection = ExpenseComponentDetection;
    class ExpenseFieldType extends base_1.ApiObjectWrapper {
        constructor(dict, parentField) {
            super(dict);
            this._parentField = parentField;
        }
    ...
    exports.ExpenseFieldType = ExpenseFieldType;
    class ExpenseField extends base_1.ApiObjectWrapper {
    ...
    class ExpenseLineItem extends base_1.ApiObjectWrapper {
        ...
        iterFields() {
            return (0, base_1.getIterable)(() => this._fields);
        }
        listFields() {
    ...
    exports.ExpenseLineItem = ExpenseLineItem;
    class ExpenseLineItemGroup extends base_1.ApiObjectWrapper {
        ...
        iterLineItems() {
            return (0, base_1.getIterable)(() => this._lineItems);
        }
        listLineItems() {
            return this._lineItems.slice();
        }
    }
    exports.ExpenseLineItemGroup = ExpenseLineItemGroup;
    class ExpenseDocument extends base_1.ApiObjectWrapper {
        ...
        iterLineItemGroups() {
            return (0, base_1.getIterable)(() => this._lineItemGroups);
        }
        iterSummaryFields() {
            return (0, base_1.getIterable)(() => this._summaryFields);
        }
        listLineItemGroups() {
    ...
    class TextractExpense extends base_1.ApiObjectWrapper {
        constructor(textractResult) {
            ...
            this._metadata = new base_1.DocumentMetadata(textractResult.DocumentMetadata);
        ...
        iterDocs() {
            return (0, base_1.getIterable)(() => this._docs);
        }
        listDocs() {
            return this._docs.slice();
        }
    }
    exports.TextractExpense = TextractExpense;
});
