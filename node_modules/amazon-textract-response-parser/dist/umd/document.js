(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./base", "./content", "./form", "./geometry", "./table", "./base", "./content"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.FormsComposite = exports.TextractDocument = exports.Table = exports.Row = exports.MergedCell = exports.CellBase = exports.Cell = exports.Form = exports.FieldValue = exports.FieldKey = exports.Field = exports.Line = exports.Page = exports.Word = exports.SelectionElement = exports.ApiBlockWrapper = void 0;
    ...
    Object.defineProperty(exports, "ApiBlockWrapper", { enumerable: true, get: function () { return base_2.ApiBlockWrapper; } });
    ...
    class Page extends base_1.ApiBlockWrapper {
        ...
        getModalWordOrientationDegrees() {
            ...
            const wordDegrees = []
                ...
                .filter((n) => n != null);
            return (0, base_1.modalAvg)(wordDegrees.map((n) => Math.round(n)));
        }
        ...
        iterLines() {
            return (0, base_1.getIterable)(() => this._lines);
        }
        iterTables() {
            return (0, base_1.getIterable)(() => this._tables);
        }
        lineAtIndex(ix) {
    ...
    exports.Cell = Cell;
    class CellBase extends table_1.CellBaseGeneric {
    }
    ...
    exports.Table = Table;
    class TextractDocument extends base_1.ApiObjectWrapper {
        ...
        iterPages() {
            return (0, base_1.getIterable)(() => this._pages);
        }
        listBlocks() {
