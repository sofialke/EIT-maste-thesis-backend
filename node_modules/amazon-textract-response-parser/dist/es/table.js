...
export class CellBaseGeneric extends ApiBlockWrapper {
...
export class CellGeneric extends CellBaseGeneric {
    constructor(block, parentTable) {
        ...
        (block.Relationships || []).forEach((rs) => {
            if (rs.Type == "CHILD") {
                rs.Ids.forEach((cid) => {
                    ...
                    if (blockType == "WORD") {
                        const w = new Word(childBlock);
                        this._content.push(w);
                        texts.push(w.text);
                    }
                    else if (blockType == "SELECTION_ELEMENT") {
                        const se = new SelectionElement(childBlock);
...
export class MergedCellGeneric extends CellBaseGeneric {
    constructor(block, parentTable) {
        super(block, parentTable);
        let cells = [];
        (block.Relationships || []).forEach((rs) => {
...
export class TableGeneric extends ApiBlockWrapper {
